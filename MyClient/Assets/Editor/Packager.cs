...
public class Packager
{
    ...
    static void HandleUIBundle()
    {
        string resPath = AppDataPath + "/" + AppConst.AssetDir + "/";
        if (!Directory.Exists(resPath)) Directory.CreateDirectory(resPath);
        AddBuildMap(AppConst.AssetDir + AppConst.ExtName, "", AppConst.AssetDir);

        AddBuildMap("UICommonElement" + AppConst.ExtName, "*.png", "Assets/Art/UI/SharedImage/UICommonElement");
        AddBuildMap("UIElements" + AppConst.ExtName, "*.png", "Assets/Art/UI/SharedImage/UIElements");
        AddBuildMap("UIItem" + AppConst.ExtName, "*.png", "Assets/Art/UI/SharedImage/UIItem");
        string[] Dirs = Directory.GetDirectories("Assets/Art/UI/Prefab", "Main_*");
        foreach (string dir in Dirs)
        {
            string stream_path = Path.GetFileNameWithoutExtension(dir);
            AddBuildMap(stream_path.Substring("Main_".Length, stream_path.Length - "Main_".Length) + AppConst.ExtName, "*.prefab", dir);
        }
